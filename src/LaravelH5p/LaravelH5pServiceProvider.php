...
use thomasmars\LaravelH5p\Commands\MigrationCommand;
use thomasmars\LaravelH5p\Commands\ResetCommand;
use thomasmars\LaravelH5p\Helpers\H5pHelper;
use thomasmars\LaravelH5p\Http\Middleware\IeFix;
...
class LaravelH5pServiceProvider extends \Illuminate\Support\ServiceProvider {
     ...
     */
    protected $listen = [
        'thomasmars\LaravelH5p\Events\H5pEvent' => [
            'thomasmars\LaravelH5p\Listeners\H5pNotification',
        ],
    ];
